...
while endGame != 'quit':
    ...
    if (r.status_code != 200):
        ...
        if user_answer == correct_answer:
            ...
            print('Sorry, ', html.unescape(user_answer), 'is not correct. The correct answer is : ', html.unescape(correct_answer))
            score_incorrect += 1
        ...
        endGame = input('\nPress and enter to play again or type "quit" ').lower()
